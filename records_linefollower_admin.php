        ...
        <table>
            ...
            foreach($records as $a): 
                ...
                <tr>
                    ...
                    <!--Variables in the link store data that will help edit the necessary records in database-->
		            <td><a href="table_linefollower_admin.php?action=edit&id=<?=$a['id']?>&tablename=<?=$tablename?>">Редактировать</a></td>
	            </tr>
            <?php endforeach ?>
        </table>
        <br><br>
